 ...
 * Handles validations.
 */
public class TreeValidationHandler<B>
{
//   private static final Logger LOGGER = LoggerFactory.getLogger(ValidationHandler.class);
    ...
    */
   public TreeValidationHandler(PresentationModel<B> subject, Validator<B> validator)
   {
    ...
    */
   public void observeSelectionChange(SelectionInTree selectionInList)
   {
      if (this.selectionInTree != null)
         this.selectionInTree.removeValueChangeListener(selectionChangeListener);

      this.selectionInTree = selectionInList;
   ...
   private class ValueChangeListener implements PropertyChangeListener, ActionListener
   {
      ...
      public void actionPerformed(ActionEvent e)
      {
         ...
         if (selectionInTree != null && selectionInTree.getSelection() != null)
         {
            @SuppressWarnings("unchecked")
            B selectedObject = (B) selectionInTree.getSelection();

            result = validator.validate(selectedObject);
         }
